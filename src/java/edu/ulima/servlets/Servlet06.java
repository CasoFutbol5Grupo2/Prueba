 ...
 * @author USER
 */
@WebServlet(name = "Servlet06", urlPatterns = {"/s06"})
public class Servlet06 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Reserva> lista = g.buscarPartidosOrganizados(actual);
       ...
       response.sendRedirect("organizador.jsp");
        ...
        List<Reserva> l= g.buscarPartidosInscritos(actual);
        
        ses.setAttribute("PartidosInscritos", l);
