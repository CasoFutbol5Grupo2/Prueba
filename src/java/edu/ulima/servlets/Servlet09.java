 ...
 * @author D2042
 */
@WebServlet(name = "Servlet09", urlPatterns = {"/s09"})
public class Servlet09 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Reserva escogida = g.verPartido(idR);
        ses.setAttribute("detalleReserva", escogida);
        response.sendRedirect("partidoInscribir.jsp");
