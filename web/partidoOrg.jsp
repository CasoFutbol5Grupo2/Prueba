...
<html>
    ...
    <form action="s13" method="POST">
                <div class="small-12 columns">
                    <center>¿Confirmar o Cancelar?</center>
                    <br>
                </div>
            <div class="row">                   
                    <div class="small-6 columns"><p align="right"><input type="radio" name="conf" value="confirmado"/>Confirmar Partido (Requiere 10 jugadores)</p>
                    </div>
                
                    <div class="small-6 columns"><p align="left"><input type="radio" name="conf" value="cancelado"/>Cancelar Partido</p>
                    </div>
                <center>
                    <div class="small-12 columns"><button type="submit">Aceptar</button>
                    </div>
                </center>
            </div>
            </form> 
